...
**Authentication** is the process of determining the validity of one or more authenticators used to claim a digital identity. Authentication establishes that a subject attempting to access a digital service is in control of the technologies used to authenticate. 
...
User IDs are usually generated by database engines and are usually numeric and sequential. From a security standpoint, this design choice tends to leak information, like how many registered users your platform has, and in cases of authorization vulnerabilities (BAC), this enables attackers to generate more impact. 
