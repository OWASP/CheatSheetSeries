---
title: DRAFT Denial of Service Cheat Sheet
permalink: /DRAFT_Denial_of_Service_Cheat_Sheet/
---
...
To remain resilient and resistant, it’s imperative - and suggested - to outline and to conduct a thorough analysis on components within your inventory based on functionality, architecture and performance (i.e. application-wise, infrastructure and network related). [thumb](/File:Flow_ddos_cheatsheet_sessions.jpg\ "wikilink") The outcome of this research should identify potential causes of a DoS which highlight single point of failures ranging from programming related errors to resource exhaustion..
...
Veelgebruikte attack Tools vermelden of buiten scope van een cheat sheet?
...
-   **Limit file upload size and extensions** (resource exhaustion) to prevent DoS on file space storage or other web application functions which will use the upload as input (e.g. image resizing, PDF creation, etc.)https://www.owasp.org/index.php/Unrestricted_File_Upload
...
Stephen Corbiaux  - stephen.corbiaux \[at\] owasp.org
