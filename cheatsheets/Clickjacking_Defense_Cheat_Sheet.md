...
Additionally, while `SameSite` attribute is supported by [most modern browsers](https://caniuse.com/#feat=same-site-cookie-attribute), there are still many users (approximately 12% as of August 2019) with browsers which do not support it.
