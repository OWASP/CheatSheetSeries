...
- Modern credential-guessing attacks commonly leverage large password wordlists, common-password dictionaries, and credentials obtained from previous data breaches. These behaviors are reflected in [MITRE ATT&CK T1110 – Brute Force](https://attack.mitre.org/techniques/T1110/), including T1110.001 (Password Guessing), which describes the use of lists of common passwords; T1110.003 (Password Spraying), which uses a small set of common passwords across many accounts; and T1110.004 (Credential Stuffing), which uses credentials obtained from breach dumps.
