...
-   Strict key rotation and token lifetime policies should be maintained. Policies can be set according to your organizational needs. Generic key management guidance from OWASP can be found [here](/Key_Management_Cheat_Sheet\ "wikilink").
...
-   For Java: OWASP [CSRF Guard](/CSRF_Guard "wikilink")
-   For PHP and Apache: [CSRFProtector Project](/CSRFProtector_Project "wikilink")
...
-   Get the tokens automatically added on the client side when the page is being rendered in user’s browser, with help of a client side script (this approach is used by [CSRF Guard](/CSRF_Guard "wikilink")). You need to consider any possible JavaScript hijacking attacks.
...
-   More myths can be found [here](/Cross-Site_Request_Forgery_(CSRF)\ "wikilink")
