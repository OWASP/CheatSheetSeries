...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://cheatsheetseries.owasp.org/cheatsheets/Cryptographic_Storage_Cheat_Sheet.html">
      
      
        <link rel="prev" href="Cross_Site_Scripting_Prevention_Cheat_Sheet.html">
      
      
        <link rel="next" href="DOM_Clobbering_Prevention_Cheat_Sheet.html">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.42">
        ...
        <title>Cryptographic Storage - OWASP Cheat Sheet Series</title>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <span class="md-ellipsis">
    Cryptographic Storage
      ...
      <a href="Cryptographic_Storage_Cheat_Sheet.html" class="md-nav__link md-nav__link--active">
  ...
  <a href="#cipher-modes" class="md-nav__link">
    <span class="md-ellipsis">
      Cipher Modes
          ...
          <li class="md-nav__item">
  <a href="#random-padding" class="md-nav__link">
    <span class="md-ellipsis">
      Random Padding
    </span>
  </a>
...
<p>Passwords should not be stored using reversible encryption - secure password hashing algorithms should be used instead. The <a href="Password_Storage_Cheat_Sheet.html">Password Storage Cheat Sheet</a> contains further guidance on storing passwords.</p>
...
<p>This process should begin with considering the <a href="Threat_Modeling_Cheat_Sheet.html">threat model</a> of the application (i.e, who you are trying to protect that data against).</p>
<p>The use of dedicated secret or key management systems can provide an additional layer of security protection, as well as making the management of secrets significantly easier - however it comes at the cost of additional complexity and administrative overhead - so may not be feasible for all applications. Note that many cloud environments provide these services, so these should be taken advantage of where possible. The <a href="Secrets_Management_Cheat_Sheet.html">Secrets Management Cheat Sheet</a> contains further guidance on this topic.</p>
...
<h3 id="random-padding">Random Padding<a class="headerlink" href="#random-padding" title="Permanent link">&para;</a></h3>
<p>For RSA, it is essential to enable Random Padding. Random Padding is also known as OAEP or Optimal Asymmetric Encryption Padding. This class of defense protects against Known Plain Text Attacks by adding randomness at the beginning of the payload.</p>
<p>The Padding Schema of <a href="https://wikipedia.org/wiki/RSA_(cryptosystem)#Padding_schemes">PKCS#1</a> is typically used in this case.</p>
...
<tr>
<td>Java</td>
<td><code>Math.random()</code>, <code>StrictMath.random()</code>, <code>java.util.Random</code>, <code>java.util.SplittableRandom</code>, <code>java.util.concurrent.ThreadLocalRandom</code></td>
<td><a href="https://docs.oracle.com/javase/8/docs/api/java/security/SecureRandom.html">java.security.SecureRandom</a>, <a href="https://docs.oracle.com/javase/8/docs/api/java/util/UUID.html#randomUUID--">java.util.UUID.randomUUID()</a></td>
</tr>
<tr>
<td>PHP</td>
<td><code>array_rand()</code>, <code>lcg_value()</code>, <code>mt_rand()</code>, <code>rand()</code>, <code>uniqid()</code></td>
<td><a href="https://www.php.net/manual/en/function.random-bytes.php">random_bytes()</a>, <a href="https://www.php.net/manual/en/class.random-engine-secure.php">Random\Engine\Secure</a> in PHP 8, <a href="https://www.php.net/manual/en/function.random-int.php">random_int()</a> in PHP 7, <a href="https://www.php.net/manual/en/function.openssl-random-pseudo-bytes.php">openssl_random_pseudo_bytes()</a> in PHP 5</td>
</tr>
<tr>
<td>.NET/C#</td>
<td><code>Random()</code></td>
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.randomnumbergenerator?view=net-6.0">RandomNumberGenerator</a></td>
</tr>
<tr>
<td>Objective-C</td>
<td><code>arc4random()</code>/<code>arc4random_uniform()</code> (Uses RC4 Cipher), subclasses of<code>GKRandomSource</code>, rand(), random()</td>
...
<td><a href="https://nodejs.org/api/crypto.html#cryptorandombytessize-callback">crypto.randomBytes()</a>, <a href="https://nodejs.org/api/crypto.html#cryptorandomintmin-max-callback">crypto.randomInt()</a>, <a href="https://nodejs.org/api/crypto.html#cryptorandomuuidoptions">crypto.randomUUID()</a></td>
</tr>
</tbody>
</table>
...
<ul>
<li>If the previous key is known (or suspected) to have been compromised.<ul>
<li>This could also be caused by a someone who had access to the key leaving the organisation.</li>
</ul>
</li>
<li>After a specified period of time has elapsed (known as the cryptoperiod).<ul>
...
<li>After the key has been used to encrypt a specific amount of data.<ul>
<li>This would typically be <code>2^35</code> bytes (~34GB) for 64-bit keys and <code>2^68</code> bytes (~295 exabytes) for 128-bit block size.</li>
</ul>
</li>
...
<li>An external secrets management service such as <a href="https://github.com/cyberark/conjur">Conjur</a> or <a href="https://github.com/hashicorp/vault">HashiCorp Vault</a>.</li>
...
<p>The <a href="Secrets_Management_Cheat_Sheet.html">Secrets Management Cheat Sheet</a> provides more details on securely storing secrets.</p>
