...
As a basic start, e# Secure Product Design Cheat Sheet
...
- Prasad-JB
stablish secure defaults, minimise the attack surface area, and fail securely to those well-defined and understood defaults.
