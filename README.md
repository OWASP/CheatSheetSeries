...
Decision of the core team have the same weight as the project leaders, so, if a core team member rejects a PR (*rejection must be technically documented and explained*) then the project leaders will apply the global decision.
